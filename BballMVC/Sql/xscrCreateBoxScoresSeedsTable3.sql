...
Declare  @tmpBoxScoresSeeds TABLE (
	[Team] [nvarchar](6) NOT NULL,
	[Venue] [nvarchar](6) NOT NULL,

	[ShotsMadePt1] [float] NOT NULL,
	[ShotsMadePt2] [float] NOT NULL,
	[ShotsMadePt3] [float] NOT NULL,
	[ShotsAllowedPt1] [float] NOT NULL,
	[ShotsAllowedPt2] [float] NOT NULL,
	[ShotsAllowedPt3] [float] NOT NULL
	...
	-- Get Away RotNum & TeamAway
		...
		If @@ROWCOUNT = 0
			...
			BEGIN	-- Venue Loop
				...
				INSERT INTO @tmpBoxScoresSeeds		-- Each Venue - from BoxScores
				(
				  [Team] ,[Venue]	-- 6

				,[ShotsMadePt1]				,[ShotsMadePt2]				,[ShotsMadePt3]				--3
				,[ShotsAllowedPt1]			,[ShotsAllowedPt2]			,[ShotsAllowedPt3]			-- 3


				)
				Select  @Team , @Venue				-- 1-6
