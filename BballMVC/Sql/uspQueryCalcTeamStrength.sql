...
(       
		...
		, @TmStrAdjPct  float = .70			-- 5
		, @BxScAdjPct float = .30				-- 6	30% of of the ActualScore will be curved back to line ex: Actual: 30 Line: 20 - 30% of 10 = 3. Actual goes from 30 to 27
		, @AvgLgScoreAway float	= 108.35667 -- 7
		, @AvgLgScoreHome float = 111.21		-- 8  	
		, @varLgAvgGamesBack int = 1			-- 9  
)
AS
SET NOCOUNT ON;
