...
namespace BballMVC.Controllers
{
    public class AdjustmentsCodesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdjustmentsCodesID,Type,Description,Range,BypassDropDown")] AdjustmentsCodes adjustmentsCodes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdjustmentsCodesID,Type,Description,Range,BypassDropDown")] AdjustmentsCodes adjustmentsCodes)
        {
            if (ModelState.IsValid)
            {
