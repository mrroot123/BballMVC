...
namespace BballMVC.Controllers
{
    public class UserLeagueParmsController : BaseController
    {
      ...
      public ActionResult Details(int? id)
        ...
        public ActionResult Edit([Bind(Include = "UserLeagueParmsID,UserName,LeagueName,StartDate,LgAvgStartDate,LgAvgGamesBack,TeamAvgGamesBack,TeamPaceGamesBack,TeamStrengthGamesBack,VolatilityGamesBack,TeamSeedGames,LoadRotationDaysAhead,GB1,GB2,GB3,WeightGB1,WeightGB2,WeightGB3,Threshold,BxScLinePct,BxScTmStrPct,TmStrAdjPct,RecentLgHistoryAdjPct,TeamPaceAdjPct,TeamAdjPct,BothHome_Away,BoxscoresSpanSeasons")]
               UserLeagueParms userLeagueParms)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Editold([Bind(Include = 
